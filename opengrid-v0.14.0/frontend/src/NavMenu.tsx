...
export default function NavMenu({active}:{active:"map"|"plugins"|"artifacts"}){
 ...
 return <div className="navMenu" ref={root}>
  ...
  {open&&<div className="navDropdown">
   ...
   <a className={active==="plugins"?"active":""} href="/plugins" target="_blank" rel="noopener noreferrer">Plugins ↗</a>
   <a className={active==="artifacts"?"active":""} href="/artifacts" target="_blank" rel="noopener noreferrer">Artifacts ↗</a>
  </div>}
 </div>
}
