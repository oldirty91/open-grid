...
## v0.13.0 ENC usability and plugin configuration
...
Import raster `.mbtiles` files from **Artifacts → Map Library**, or copy them into `map-library/`. Maps are retained on disk and served locally for disconnected operation. See `docs/MAP_ENGINE.md`.
