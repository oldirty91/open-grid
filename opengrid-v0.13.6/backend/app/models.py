...
class TaskDependency(BaseModel):
    task_id: str
    required_status: str = "STATUS_DONE_OK"
...
class PluginGisLayer(BaseModel):
    layer_id: str
    name: str
    description: str | None = None
    geometry_type: str = "mixed"
    service_url: str
...
class PluginGisLayerRegistration(BaseModel):
    layers: list[PluginGisLayer]
...
class ArtifactCreateBinary(BaseModel):
    name: str
