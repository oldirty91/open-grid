...
## Source-independent Geo-Entities

A Geo-Entity is a Geo-Entity regardless of origin. User-created geometry, imported
ENC objects, and future geospatial data adapters all publish the same core
`GEOENTITY` Entity representation. Source provenance identifies where the object
came from; it does not change its Entity category.
