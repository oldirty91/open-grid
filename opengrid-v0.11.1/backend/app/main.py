...
async def seed_demo_overlay():
    ...
    metadata = {
        ...
        "tile_url": "https://gis.charttools.noaa.gov/arcgis/rest/services/MarineChart_Services/NOAACharts/MapServer/WMTS/tile/1.0.0/MarineChart_Services_NOAACharts/default/GoogleMapsCompatible/{z}/{y}/{x}.png",
...
async def health():
    return {"status": "ok", "service": "opengrid-api", "version": "0.11.1", "artifact_storage_ready": bool(getattr(app.state, "artifact_storage_ready", False))}
