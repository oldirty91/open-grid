...
export default function App(){
 ...
 const contacts=useMemo(()=>visible.filter(e=>e.template==="TRACK"),[visible]);
 const operationalAssets=useMemo(()=>visible.filter(e=>e.template==="ASSET"||e.template==="SENSOR"),[visible]);
 useEffect(()=>{try{const saved=localStorage.getItem("opengrid.leftDrawer");if(saved==="contacts"||saved==="assets"||saved==="closed")setLeftDrawer(saved==="closed"?null:saved)}catch{}},[]);
