...
- Removed MBTiles/Map Engine plugin and routes
...
- Added the missing Map Engine service to Docker Compose.
- Replaced large browser MBTiles uploads with a watched offline map directory.
- Added recursive MBTiles discovery and a local registry snapshot.
- Kept NOAA ENC registered through the unified GIS API during the refactor.

# 0.13.1

- Added the offline Map Engine plugin and raster MBTiles library.
- Added MBTiles import, removal, and map visibility controls to Artifacts.
