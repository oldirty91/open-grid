...
class OpenGridClient:
    ...
    async def publish_entity(self, entity_id: str, components: dict[str, Any], *, is_live: bool = True, provenance: dict[str, Any] | None = None, expiry_time: str | None = None) -> dict[str, Any]:
        payload={"entity_id":entity_id,"is_live":is_live,"expiry_time":expiry_time,"components":components,"provenance":provenance or {},"component_times":{k:__import__("datetime").datetime.now(__import__("datetime").timezone.utc).isoformat() for k in components}}
