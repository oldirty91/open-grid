...
class OpenGridAdapter:
    ...
    async def publish_entity(self, entity_id: str, components: dict[str, Any], *, is_live: bool=True, provenance: dict[str, Any] | None=None, expiry_time: str | None=None):
        return await self.client.publish_entity(entity_id, components, is_live=is_live, provenance=provenance, expiry_time=expiry_time)
