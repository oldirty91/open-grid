...
async def register(c):
 await api(c,"POST","/api/v1/plugins/register",json={"plugin_id":PLUGIN_ID,"name":"MAVLink","version":"0.3.1",
 ...
 "configuration_schema":{"type":"object","properties":{
  "connection_type":{"type":"string","title":"Connection type","enum":["tcp","udp_listen","udp_remote","serial"],"description":"How OpenGrid connects to the MAVLink endpoint."},
  "tcp_host":{"type":"string","title":"TCP host"},
  "tcp_port":{"type":"integer","title":"TCP port","minimum":1,"maximum":65535},
  "udp_listen_host":{"type":"string","title":"UDP listen host"},
  "udp_listen_port":{"type":"integer","title":"UDP listen port","minimum":1,"maximum":65535},
  "udp_remote_host":{"type":"string","title":"UDP remote host"},
  "udp_remote_port":{"type":"integer","title":"UDP remote port","minimum":1,"maximum":65535},
  "serial_device":{"type":"string","title":"Serial device"},
  "serial_baud":{"type":"integer","title":"Serial baud","minimum":1200},
  "source_system":{"type":"integer","title":"OpenGrid MAVLink system ID","minimum":1,"maximum":255},
  "heartbeat_timeout_s":{"type":"number","title":"Heartbeat timeout (seconds)","minimum":1},
  "command_timeout_s":{"type":"number","title":"Command timeout (seconds)","minimum":1},
  "default_altitude_m":{"type":"number","title":"Default navigation altitude (m)","minimum":0},
  "takeoff_altitude_m":{"type":"number","title":"Default takeoff altitude (m)","minimum":1}
